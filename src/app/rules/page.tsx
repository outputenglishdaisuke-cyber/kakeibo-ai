...
export default function RulesPage() {
  ...
  const inputClass =
    "h-11 w-full rounded-lg border border-gray-300 px-3 text-base focus:border-indigo-500 focus:outline-none md:h-auto md:w-auto md:py-2 md:text-sm";
        ...
        <CardContent>
          <div className="flex flex-col gap-4 md:flex-row md:flex-wrap md:items-end">
            <div className="w-full md:w-auto">
              <label className="mb-1 block text-xs font-medium text-gray-700">キーワード</label>
              <input
                type="text"
            ...
            <div className="w-full md:w-auto">
              <label className="mb-1 block text-xs font-medium text-gray-700">分類先カテゴリ</label>
              <select
                className={inputClass}
            ...
            <div className="w-full md:w-auto">
              <label className="mb-1 block text-xs font-medium text-gray-700">優先度</label>
              <input
                type="number"
                className="h-11 w-full rounded-lg border border-gray-300 px-3 text-base focus:border-indigo-500 focus:outline-none md:h-auto md:w-20 md:py-2 md:text-sm"
                value={form.priority}
            ...
            <Button
              ...
              onClick={createRule}
              disabled={!form.keyword.trim() || !form.categoryId}
            >
